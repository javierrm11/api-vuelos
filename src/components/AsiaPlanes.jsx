...
function AsiaPlanes() {
  ...
  return (
    <div>
      <h2>Avión más rápido de Asia</h2>
      <p>Hex: {data.masRapidoDeAsia.hex}</p>
      <p>Velocidad: {data.masRapidoDeAsia.velocidad} km/h</p>

      <h2>Avión más lento de Asia</h2>
      <p>Hex: {data.masLentoDeAsia.hex}</p>
      <p>Velocidad: {data.masLentoDeAsia.velocidad} km/h</p>

      <h2>Consumo y emisiones promedio</h2>
      <p>Consumo medio: {avgFuel ?? 'Calculando...'} L/h</p>
      <p>Emisión media: {avgCO2 ?? 'Calculando...'} kg CO₂/h</p>

      <h2>Todos los aviones detectados en Asia</h2>
      <ul>
