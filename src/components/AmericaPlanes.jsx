...
function AmericaPlanes() {
  ...
  return (
    <div>
      <h2>Avión más rápido de América</h2>
      <p>Hex: {data.masRapidoDeAmerica.hex}</p>
      <p>Velocidad: {data.masRapidoDeAmerica.velocidad} km/h</p>

      <h2>Avión más lento de América</h2>
      <p>Hex: {data.masLentoDeAmerica.hex}</p>
      <p>Velocidad: {data.masLentoDeAmerica.velocidad} km/h</p>

      <h2>Consumo y emisiones promedio</h2>
      <p>Consumo medio: {avgFuel ?? 'Calculando...'} L/h</p>
      <p>Emisión media: {avgCO2 ?? 'Calculando...'} kg CO₂/h</p>

      <h2>Todos los aviones detectados en América</h2>
      <ul>
