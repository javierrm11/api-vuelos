...
function AfricaPlanes() {
  ...
  return (
    <div>
      <h2>Avión más rápido de África</h2>
      <p>Hex: {data.masRapidoDeAfrica.hex}</p>
      <p>Velocidad: {data.masRapidoDeAfrica.velocidad} km/h</p>

      <h2>Avión más lento de África</h2>
      <p>Hex: {data.masLentoDeAfrica.hex}</p>
      <p>Velocidad: {data.masLentoDeAfrica.velocidad} km/h</p>

      <h2>Consumo y emisiones promedio</h2>
      <p>Consumo medio: {avgFuel ?? 'Calculando...'} L/h</p>
      <p>Emisión media: {avgCO2 ?? 'Calculando...'} kg CO₂/h</p>

      <h2>Todos los aviones detectados en África</h2>
      <ul>
